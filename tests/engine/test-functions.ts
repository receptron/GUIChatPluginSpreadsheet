 ...
 * Run with: npx tsx tests/engine/test-functions.ts
 */

import { functionRegistry } from "../../src/engine/registry";
import type { FunctionContext } from "../../src/engine/registry";
import "../../src/engine/functions"; // Load all functions
